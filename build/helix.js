...
HX.InitOptions = function()
{
    ...
    // debug-related
    this.ignoreDrawBuffersExtension = true;     // forces multiple passes for the GBuffer
    this.ignoreDepthTexturesExtension = true;     // forces storing depth info explicitly
