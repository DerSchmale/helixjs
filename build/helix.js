...
DynamicLitProbePass.prototype.updatePassRenderState = function(renderer, probe)
{
    ...
    this._diffuseSlot.texture = DynamicLitProbePass.dummyTexture; probe.diffuseTexture;
