...
function initScene(scene, assetLibrary)
{
    ...
    var plane = new HX.PlanePrimitive();
    ...
    var leftWall = new HX.Entity(new HX.MeshInstance(plane, materialRed));
    var rightWall = new HX.Entity(new HX.MeshInstance(plane, materialGreen));
    var topWall = new HX.Entity(new HX.MeshInstance(plane, materialWhite));
    var bottomWall = new HX.Entity(new HX.MeshInstance(plane, materialWhite));
    var backWall = new HX.Entity(new HX.MeshInstance(plane, materialWhite));
    leftWall.position.x = -0.5;
    leftWall.euler.y = Math.PI * .5;
    rightWall.position.x = 0.5;
	rightWall.euler.y = -Math.PI * .5;
	topWall.position.z = 0.5;
	topWall.euler.x = Math.PI;
    bottomWall.position.z = -0.5;
    backWall.position.y = 0.5;
    backWall.euler.x = Math.PI * .5;
    ...
    // this is how the hdr maps were made before processing them into sh maps
    // main specular map:
