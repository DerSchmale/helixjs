 ...
 * <ul>
 * <li>radianceToIrradiance: True if the ASH file contains a SH approximation for the radiance and the irradiance is required.
 * </ul>
 *
 * @constructor
 *
...
ASH.prototype.parse = function(data, target)
{
	...
	for (var i = 0; i < numLines; ++i) {
        ...
        if (line.label === "l") {
        	...
        	var val = line.value;
        	if (this.options.radianceToIrradiance) {
				val *= Math.PI;
				if (level === 1)
					val *= 2 / 3;
				else if (level === 2)
			...
			target.setWeight(level, line.index, val);
		}
	}
